...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        imageLabelConductivityPh.pack(pady=10, padx=10)
...
ani1 = animation.FuncAnimation(last24HoursFigureTemperature, animateLast24HoursTemperature, interval=400000,
                               blit=False)
ani2 = animation.FuncAnimation(lastYearFigureTemperature, animateLastYearTemperature, interval=400000,
                               blit=False)
# Animations for Conductivity
ani3 = animation.FuncAnimation(last24HoursFigureConductivity, animateLast24HoursConductivity, interval=400000,
                               blit=False)
ani4 = animation.FuncAnimation(lastYearFigureConductivity, animateLastYearConductivity, interval=400000,
                               blit=False)
# Animations for pH
ani5 = animation.FuncAnimation(last24HoursFigurePh, animateLast24HoursPh, interval=400000, blit=False)
ani6 = animation.FuncAnimation(lastYearFigurePh, animateLastYearPh, interval=400000, blit=False)
app.mainloop()
